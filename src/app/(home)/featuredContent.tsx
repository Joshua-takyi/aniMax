...
export default function FeaturedContent() {
	return (
		...
		<section className="lg:bg-[url(/images/113fdbfd-heroimages-swimlanes-03dubs-danmachiv.jpg)] bg-cover bg-no-repeat h-[70dvh]  lg:px-10 bg-[url(/images/eis-02-1040x1560.original.jpg)]">
